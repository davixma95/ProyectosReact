...
//  la función debe imprimir una cuenta atrás desde ese número hasta 0.
...
const suma = array => {
    const sum = array.reduce((prev, acc) => prev + acc, 0)
    console.log(sum)
}
...
const multiplicar =(numero) => {
    for(let i = 1; i <= 10; i++) {
      console.log(`${i} * ${numero} x `, i * numero);
    }
}
...
const adivinarAnios = (numero) => {
  let aux = 1;
  for(let i = 2023; numero<i;numero++){
    
    console.log(`Naciste en el anio ${numero}, en el año ${numero} cumpliste ${aux} año`)
    if(aux==1){
      console.log(`Naciste en el anio ${numero}, en el año ${numero} cumpliste ${aux} año`)
    } else {
      console.log(`Naciste en el anio ${numero}, en el año ${numero} cumpliste ${aux} años`)
    }
    aux = aux+1;
  }
}
...
const pares = (num1, num2) => {
  for(let i = num1; i < num2;i++){
    if(i % 2 == 0){
      console.log(`La i vale ${i}`)  
    }
    // console.log('LA I ',i);
    // console.log('El num 2 ',num2);
